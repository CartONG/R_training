...
# check Burnika Faso cops 
crop_check(df19,
           "Baseline",
           "Burkina Faso")

# plot the crops we are intersted in
crop_yield(df19, "Pumpkins, squash and gourds",
                     "Baseline", "Angola", 
                     Threshold = 350 ,
                     Bin_width = 350)
